...
from .gaussian_model_new import GaussianModel
from flame_utils.graphics_utils import compute_face_orientation
# from pytorch3d.transforms import matrix_to_quaternion
from roma import rotmat_to_unitquat, quat_xyzw_to_wxyz


class FlameGaussianModel(GaussianModel):
    def __init__(self, sh_degree: int, disable_flame_static_offset=False, not_finetune_flame_params=False, n_shape=300,
                 n_expr=100, anchor_weight_init_g0=1.0,
                 anchor_weight_init=0.1,
                 anchor_weight_multiplier=2):
        super().__init__(sh_degree,anchor_weight_init_g0,anchor_weight_init,anchor_weight_multiplier)#
        self.anchor = {}
