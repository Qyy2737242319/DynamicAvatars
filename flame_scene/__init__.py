...
import numpy as np
import torch
from flame_utils.system_utils import searchForMaxIteration
from flame_scene.dataset_readers import sceneLoadTypeCallbacks
from flame_scene.cameras import Camera
from flame_scene.gaussian_model_new import GaussianModel
from flame_scene.flame_gaussian_model import FlameGaussianModel
from arguments import ModelParams
from flame_utils.camera_utils import cameraList_from_camInfos, camera_to_JSON
from flame_utils.general_utils import PILtoTorch
...
class Scene:
    ...
    def save_new(self, iteration):
        point_cloud_path = os.path.join(self.model_path, "point_cloud/iteration_{}".format(iteration))
        self.gaussians.save_ply(os.path.join(point_cloud_path, "static_point_cloud.ply"))
