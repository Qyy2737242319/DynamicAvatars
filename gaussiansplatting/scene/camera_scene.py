...
class CamScene:
    def __init__(self, source_path, h=512, w=512, aspect=-1,train_cameras=None,radius=None):
        """b
        ...
        if train_cameras is None and radius is None:
            ...
            self.cameras = cameraList_load(train_cameras, h, w)
